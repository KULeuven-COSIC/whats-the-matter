...
/**
 *  Implements the logic for encoding and decoding data using both the Base64 and Base64URL schemes, 
 *  providing functionality for converting between raw binary data and their text-encoded representations.
 */
